...
{
	CCLayerColor* colorBackground = CCLayerColor::create(ccc4(0, 0, 0, 220));
...
void MenuLayer::createMenu()
{
	...
	CCMenuItemLabel* musicOn = CCMenuItemLabel::create(CCLabelTTF::create("musicOn", fontName->getCString(), fontSize));
	CCMenuItemLabel* musicOff = CCMenuItemLabel::create(CCLabelTTF::create("musicOFF", fontName->getCString(), fontSize));
